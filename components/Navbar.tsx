  ...
  return (
    <div className='fixed h-full p-5'>
      ...
      <div>
        ...
        <div className='flex items-center p-2 mb-2 hover:bg-gray-100 duration-300 rounded-lg cursor-pointer'>
          ...
          {({ open }) => (
            <>
              <Disclosure.Button className='w-full'>
                <div className='flex items-center p-2 mb-2 hover:bg-gray-100 duration-300 rounded-lg'>
                ...
                <Disclosure.Panel className='text-gray-500'>
                  <div className='flex'>
                    ...
                    <div className='flex flex-col'>
                      <span className='ml-3 text-xs text-gray-400 font-semibold mb-4'>
                        Stock Portfolio
                      </span>
                      <span className='ml-3 text-xs text-gray-400 font-semibold mb-4'>
                        Crypto Portfolio
                      ...
                      <span className='ml-3 text-xs text-gray-400 font-semibold'>
                        Market
                      </span>
                    </div>
                  </div>
